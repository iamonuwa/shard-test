export const Illustration = () => {
  return (
    <div className="relative aspect-square w-72 flex-none">
      <svg viewBox="0 0 288 288" fill="none" className="absolute inset-0 h-full w-full overflow-visible">
        <g>
          <mask
            id="c"
      ...
      >
        ...
        />
        <g mask="url(#cc)">
          <path opacity=".1" d="M-69 287.5h445" stroke="url(#e)" strokeWidth="1.5" />
          <path opacity=".1" d="M-69 0h445" stroke="url(#f)" strokeWidth="1.5" />
          <path opacity=".1" d="M.25 355V-90" stroke="url(#g)" strokeWidth="1.5" />
          <path opacity=".1" d="M287.75 355V-90" stroke="url(#h)" strokeWidth="1.5" />
        </g>
        <defs>
